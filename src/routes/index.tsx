...
export default function Index() {
  return (
    <div className={classes.container}>
      ...
      <h1 className={classes["welcome-title"]}>Bem-vindo ao Sistema Saúde</h1>
      <p>No Sistema Saúde, nossa missão é oferecer a você acesso fácil e conveniente aos melhores especialistas médicos. Sabemos que sua saúde é uma prioridade, e é por isso que estamos comprometidos em fornecer serviços de qualidade para atender às suas necessidades.</p>
